...
# Mutations for writing data, and 
# Subscriptions for automatically receiving real-time data updates. 
...
SECRET_KEY = 'm=lf4ml94cf&w#b9uh=ku-h)l4evq%a+*34cge%l+@lsu+n7t*'
